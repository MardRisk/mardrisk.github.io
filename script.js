...
const T={
  en:{
    ...
    q1t:'"Saved me from a <em>terrible purchase</em>. I was about to spend $800 I didn\'t really have. The bot said red. I listened."',q1n:'Armen K.',q1r:'Lori Province, Armenia',
    q2t:'"Finally an AI tool that speaks <em>Armenian</em>. And actually gives useful financial advice. Incredible."',q2n:'Ani M.',q2r:'Lori Province, Armenia',
  ...
  hy:{
    ...
    q1t:'"Փրկեց ինձ <em>սարսափելի գնումից</em>: Պատրաստ էի $800 ծախսել: Bot-ն ասաց կարմիր: Ես լսեցի:"',q1n:'Արմեն Կ.',q1r:'Լոռու մարզ, Հայաստան',
    q2t:'"Վերջապես AI գործիք, որը խոսում է <em>հայերեն</em>: Եվ իրոք օգտակար ֆինանսական խորհուրդ է տալիս:"',q2n:'Անի Մ.',q2r:'Լոռու մարզ, Հայաստան',
  ...
  ru:{
    ...
    q1t:'"Спас меня от <em>ужасной покупки</em>. Я собирался потратить $800. Бот сказал красный. Я послушал."',q1n:'Армен К.',q1r:'Лорийская область, Армения',
    q2t:'"Наконец ИИ-инструмент, который говорит по-<em>армянски</em>. И даёт реально полезные советы."',q2n:'Ани М.',q2r:'Лорийская область, Армения',
